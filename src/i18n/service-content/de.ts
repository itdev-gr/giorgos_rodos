  ...
  'rhodes-boat-trips': {
    ...
    routeGuide: {
      ...
      routes: [
        ...
        {
          heading: 'Was inbegriffen ist und typische Preise für Bootsausflüge',
          body: 'Der Preis hängt davon ab, ob Sie an einem gemeinsamen Ausflug teilnehmen oder einen privaten buchen. Gemeinsame Tagestouren beginnen bei etwa €39 pro Person und umfassen meist die Route, Badestopps, Schnorchelausrüstung und bei Ganztagsfahrten Mittagessen und Getränke an Bord. Private Ausflüge mit Skipper beginnen bei rund €350 für einen halben Tag und €700+ für einen ganzen Tag, berechnet pro Boot statt pro Person — je mehr Sie sind, desto besser das Preis-Leistungs-Verhältnis. Private Preise umfassen in der Regel Treibstoff, den Skipper, Schwimm- und Schnorchelstopps und flexible Zeiten. Versteckte Extras gibt es nicht: Wir nennen den vollen Preis vor der Buchung. Sagen Sie uns Gruppengröße und Daten, und wir geben Ihnen einen ehrlichen Vergleich zwischen gemeinsamen und privaten Optionen.',
        },
        {
          heading: 'Speedboot, RIB oder Segelkatamaran — welcher Bootsausflug?',
          body: 'Die Art des Bootes prägt den ganzen Tag. Speedboote und Power-RIBs sind schnell und wendig — ideal, um Symi oder mehrere Ostküstenbuchten in einem halben Tag ohne Zeitverlust zu erreichen. Segelkatamarane tauschen Geschwindigkeit gegen Platz und Stabilität: mehr Deck, Schatten und ein entspanntes Tempo, perfekt für Familien oder bei Seekrankheit. Größere organisierte Boote eignen sich für alle, die einen festen All-inclusive-Tag zum günstigsten Preis möchten. Wenn Sie unsicher sind, sagen Sie uns, wie viele Sie sind und was am wichtigsten ist — Geschwindigkeit, Komfort oder Budget — und wir empfehlen den richtigen Rumpf. Sie können auch <a href="/service/rhodes-rent-a-boat">ein Boot selbst fahren</a> oder organisierte <a href="/service/rhodes-boat-cruises">Tageskreuzfahrten</a> für größere Gruppen ansehen.',
        },
        {
          heading: 'Wann fahren und was mitnehmen',
          body: 'Die Saison für Bootsausflüge auf Rhodos läuft von Ende April bis Oktober, mit dem ruhigsten Meer und wärmsten Wasser von Juni bis September. Morgens ist der Wind meist am schwächsten, was für die offene Überfahrt nach Symi wichtig ist; nachmittags kann es auf den exponierten Routen windiger sein. Bringen Sie Badekleidung, ein Handtuch, riffschonende Sonnencreme, einen Hut und eine leichte Jacke für die Rückfahrt mit, dazu eine wasserdichte Handyhülle auf einem Speedboot oder RIB. Die meisten Boote stellen Wasser und Schnorchelausrüstung, prüfen Sie es aber vorher. Wer empfindlich auf Bewegung reagiert, wählt einen Katamaran oder eine geschützte Ostküstenroute. Unsicher, welcher Ausflug passt? <a href="/contact">Senden Sie uns Ihre Daten</a> und wir empfehlen die richtige Route und das richtige Boot.',
        },
      ],
      closing:
