  ...
  'rhodes-boat-trips': {
    ...
    routeGuide: {
      ...
      routes: [
        ...
        {
          heading: 'Cosa è incluso e prezzi tipici delle gite in barca',
          body: 'Il prezzo dipende dal fatto che ti unisca a una gita condivisa o ne prenoti una privata. Le crociere giornaliere condivise partono da circa €39 a persona e di solito comprendono il percorso, le soste per il bagno, l’attrezzatura per lo snorkeling e, nelle gite di un’intera giornata, pranzo e bevande a bordo. Le uscite private con skipper partono da circa €350 per mezza giornata e €700+ per l’intera giornata, con prezzo a barca anziché a persona: più siete, migliore è il rapporto qualità-prezzo. Le tariffe private di solito includono carburante, skipper, soste per nuoto e snorkeling e orari flessibili. Niente costi nascosti: indichiamo il prezzo completo prima della prenotazione. Indicaci numero di persone e date e ti daremo un confronto onesto tra opzioni condivise e private.',
        },
        {
          heading: 'Motoscafo, RIB o catamarano a vela — quale gita in barca?',
          body: 'Il tipo di barca definisce l’intera giornata. Motoscafi e RIB sono veloci e agili — ideali per raggiungere Symi o più baie della costa orientale in mezza giornata senza perdere tempo. I catamarani a vela scambiano velocità con spazio e stabilità: più ponte, ombra e ritmo rilassato, perfetti per famiglie o per chi soffre il mal di mare. Le barche organizzate più grandi sono adatte a chi vuole una giornata all inclusive a prezzo fisso. Se non sei sicuro, dicci in quanti siete e cosa conta di più — velocità, comfort o budget — e ti indicheremo lo scafo giusto. Puoi anche <a href="/service/rhodes-rent-a-boat">noleggiare una barca senza patente</a> o sfogliare le <a href="/service/rhodes-boat-cruises">crociere giornaliere</a> per gruppi più numerosi.',
        },
        {
          heading: 'Quando andare e cosa portare',
          body: 'La stagione delle gite in barca a Rodi va da fine aprile a ottobre, con il mare più calmo e l’acqua più calda da giugno a settembre. Al mattino il vento è di solito più debole, importante per la traversata in mare aperto verso Symi; il pomeriggio può essere più ventoso sulle rotte esposte. Porta costume, un asciugamano, crema solare rispettosa dei fondali, un cappello e uno strato leggero per il ritorno, oltre a una custodia impermeabile per il telefono se sei su un motoscafo o RIB. La maggior parte delle barche fornisce acqua e attrezzatura per lo snorkeling, ma conviene verificare prima. Se qualcuno soffre il movimento, scegli un catamarano o una rotta riparata sulla costa orientale. Non sai quale gita scegliere? <a href="/contact">Inviaci le tue date</a> e ti consiglieremo la rotta e la barca giuste.',
        },
      ],
      closing:
