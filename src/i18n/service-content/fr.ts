  ...
  'rhodes-boat-trips': {
    ...
    routeGuide: {
      ...
      routes: [
        ...
        {
          heading: 'Ce qui est inclus et les prix habituels des excursions en bateau',
          body: 'Le prix dépend du fait que vous rejoigniez une sortie partagée ou réserviez une sortie privée. Les croisières partagées d’une journée commencent autour de €39 par personne et couvrent généralement l’itinéraire, les arrêts baignade, le matériel de snorkeling et, lors des journées complètes, le déjeuner et les boissons à bord. Les sorties privées avec skipper commencent vers €350 pour une demi-journée et €700+ pour une journée complète, au prix par bateau plutôt que par personne : plus vous êtes nombreux, meilleur est le rapport qualité-prix. Les tarifs privés incluent en général le carburant, le skipper, les arrêts baignade et snorkeling et des horaires flexibles. Pas de frais cachés : nous annonçons le prix complet avant la réservation. Indiquez-nous le nombre de personnes et vos dates et nous vous donnerons une comparaison honnête entre options partagées et privées.',
        },
        {
          heading: 'Speedboat, RIB ou catamaran à voile — quelle excursion en bateau ?',
          body: 'Le type de bateau façonne toute la journée. Les speedboats et RIB sont rapides et agiles — parfaits pour rejoindre Symi ou plusieurs criques de la côte est en une demi-journée sans perdre de temps. Les catamarans à voile échangent la vitesse contre l’espace et la stabilité : plus de pont, de l’ombre et un rythme détendu, idéals pour les familles ou en cas de mal de mer. Les bateaux organisés plus grands conviennent à ceux qui veulent une journée tout compris au meilleur prix. En cas de doute, dites-nous combien vous êtes et ce qui compte le plus — vitesse, confort ou budget — et nous vous orienterons vers la bonne coque. Vous pouvez aussi <a href="/service/rhodes-rent-a-boat">louer un bateau sans permis</a> ou parcourir les <a href="/service/rhodes-boat-cruises">croisières d’une journée</a> pour les groupes plus nombreux.',
        },
        {
          heading: 'Quand partir et quoi emporter',
          body: 'La saison des excursions en bateau à Rhodes va de fin avril à octobre, avec la mer la plus calme et l’eau la plus chaude de juin à septembre. Le matin, le vent est généralement le plus faible, ce qui compte pour la traversée en mer ouverte vers Symi ; l’après-midi peut être plus venteux sur les routes exposées. Emportez maillot, serviette, crème solaire respectueuse des fonds marins, chapeau et une couche légère pour le retour, ainsi qu’une housse étanche pour le téléphone sur un speedboat ou un RIB. La plupart des bateaux fournissent eau et matériel de snorkeling, mais vérifiez avant de partir. Si quelqu’un est sensible au mouvement, choisissez un catamaran ou une route abritée sur la côte est. Vous hésitez ? <a href="/contact">Envoyez-nous vos dates</a> et nous vous recommanderons la bonne route et le bon bateau.',
        },
      ],
      closing:
