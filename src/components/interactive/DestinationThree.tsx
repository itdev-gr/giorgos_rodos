...
export default function DestinationThree() {
  return (
    <section
        ...
        <div className="row justify-content-between">
          ...
          <div className="col-lg-5">
            ...
            <p className="sec-text mb-30">
              One of the most well-liked travel companies for people looking to experience adventure and see the world is Rodos Yachts.
            </p>
          </div>
        </div>
        <Swiper
            ...
            <SwiperSlide key={item.id}>
              <div className="destination-item th-ani">
                ...
                <div className="destination-content">
                  ...
                  <a href="/contact" className="th-btn style4 th-icon">Book Now</a>
                </div>
              </div>
            </SwiperSlide>
          ))}
